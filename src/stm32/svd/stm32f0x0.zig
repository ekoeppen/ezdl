...
pub const devices = struct {
    ...
    pub const STM32F0x0 = struct {
        ...
        pub const VectorTable = extern struct {
            ...
            DMA1_CH2_3: Handler = unhandled,
            ///  DMA1 channel 4 and 5 interrupt
            DMA1_CH4_5: Handler = unhandled,
            ///  ADC interrupt
        ...
        pub const peripherals = struct {
            ...
            pub const TIM3 = @intToPtr(*volatile types.peripherals.TIM3, 0x40000400);
            ///  Basic-timers
            ...
            pub const SYSCFG = @intToPtr(*volatile types.peripherals.SYSCFG, 0x40010000);
