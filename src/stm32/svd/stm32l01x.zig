...
pub const device_name = "STM32L0x1";
pub const device_revision = "1.3";
pub const device_description = "STM32L0x1";
...
pub const SYSCFG_COMP = struct {
    ...
    /// COMP1_CTRL
    const COMP1_CTRL_val = packed struct {
        /// COMP1EN [0:0]
    ...
    pub const COMP1_CTRL = Register(COMP1_CTRL_val).init(base_address + 0x18);

    /// COMP2_CTRL
    const COMP2_CTRL_val = packed struct {
        /// COMP2EN [0:0]
    ...
    pub const COMP2_CTRL = Register(COMP2_CTRL_val).init(base_address + 0x1c);
};
