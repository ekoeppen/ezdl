...
pub const devices = struct {
    ...
    pub const STM32L0x3 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const LCD = @intToPtr(*volatile types.LCD, 0x40002400);
            ///  Real-time clock
...
pub const types = struct {
    ...
    pub const LCD = extern struct {
        ...
        FCR: mmio.Mmio(32, packed struct {
            ///  High drive enable
            HD: u1,
        ...
        ///  clear register
        CLR: mmio.Mmio(32, packed struct {
            reserved1: u1 = 0,
        ...
        reserved20: [4]u8,
        ///  display memory
        RAM_COM0: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved28: [4]u8,
        ///  display memory
        RAM_COM1: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved36: [4]u8,
        ///  display memory
        RAM_COM2: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved44: [4]u8,
        ///  display memory
        RAM_COM3: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved52: [4]u8,
        ///  display memory
        RAM_COM4: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved60: [4]u8,
        ///  display memory
        RAM_COM5: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved68: [4]u8,
        ///  display memory
        RAM_COM6: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
        ...
        reserved76: [4]u8,
        ///  display memory
        RAM_COM7: mmio.Mmio(32, packed struct {
            ///  S00
            S00: u1,
            ///  S01
            S01: u1,
