...
pub const devices = struct {
    ...
    pub const STM32L0x3 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const LCD = @intToPtr(*volatile types.peripherals.LCD, 0x40002400);
            ///  Real-time clock
            ...
            ///  Universal synchronous asynchronous receiver transmitter
            pub const LPUSART1 = @intToPtr(*volatile types.peripherals.LPUSART1, 0x40004800);
            ///  Universal synchronous asynchronous receiver transmitter
            ...
            pub const USB_FS = @intToPtr(*volatile types.peripherals.USB_FS, 0x40005c00);
            ///  Universal serial bus full-speed device interface
            pub const USB_SRAM = @intToPtr(*volatile types.peripherals.USB_SRAM, 0x40006000);
            ...
            pub const RNG = @intToPtr(*volatile types.peripherals.RNG, 0x40025000);
