...
pub const device_name = "STM32F030";
pub const device_revision = "1.0";
pub const device_description = "STM32F030";
...
pub const SPI1 = struct {
    ...
    /// data register
    pub const DR16 = Register(DR16_val).init(base_address + 0xc);
...
pub const interrupts = struct {
    ...
    pub const EXTI2_3 = 6;
    pub const DMA_CH4_5_6_7 = 11;
    pub const RCC_CRS = 4;
    pub const EXTI4_15 = 7;
    pub const USART1 = 27;
    pub const TIM2 = 15;
    pub const USART3_4 = 29;
    pub const DMA_CH2_3 = 10;
    pub const USART2 = 28;
