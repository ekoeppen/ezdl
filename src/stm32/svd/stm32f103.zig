...
pub const devices = struct {
    ...
    pub const STM32F103 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  General purpose timer
            pub const TIM4 = @intToPtr(*volatile types.peripherals.TIM2, 0x40000800);
            ///  General purpose timer
            pub const TIM5 = @intToPtr(*volatile types.peripherals.TIM2, 0x40000c00);
            ///  Basic timer
            ...
            ///  General purpose timer
            pub const TIM12 = @intToPtr(*volatile types.peripherals.TIM9, 0x40001800);
            ///  General purpose timer
            pub const TIM13 = @intToPtr(*volatile types.peripherals.TIM10, 0x40001c00);
            ///  General purpose timer
            pub const TIM14 = @intToPtr(*volatile types.peripherals.TIM10, 0x40002000);
            ///  Real time clock
            ...
            ///  Serial peripheral interface
            pub const SPI3 = @intToPtr(*volatile types.peripherals.SPI1, 0x40003c00);
            ///  Universal synchronous asynchronous receiver transmitter
            pub const USART2 = @intToPtr(*volatile types.peripherals.USART1, 0x40004400);
            ///  Universal synchronous asynchronous receiver transmitter
            pub const USART3 = @intToPtr(*volatile types.peripherals.USART1, 0x40004800);
            ///  Universal asynchronous receiver transmitter
            pub const UART4 = @intToPtr(*volatile types.peripherals.UART4, 0x40004c00);
            ///  Universal asynchronous receiver transmitter
            pub const UART5 = @intToPtr(*volatile types.peripherals.UART5, 0x40005000);
            ...
            pub const USB = @intToPtr(*volatile types.peripherals.USB, 0x40005c00);
            ///  Controller area network
            pub const CAN1 = @intToPtr(*volatile types.peripherals.CAN1, 0x40006400);
            ///  Controller area network
            pub const CAN2 = @intToPtr(*volatile types.peripherals.CAN1, 0x40006800);
            ///  Backup registers
            ...
            ///  General purpose I/O
            pub const GPIOF = @intToPtr(*volatile types.peripherals.GPIOA, 0x40011c00);
            ///  General purpose I/O
            pub const GPIOG = @intToPtr(*volatile types.peripherals.GPIOA, 0x40012000);
            ///  Analog to digital converter
            pub const ADC1 = @intToPtr(*volatile types.peripherals.ADC1, 0x40012400);
            ///  Analog to digital converter
            pub const ADC2 = @intToPtr(*volatile types.peripherals.ADC2, 0x40012800);
            ///  Advanced timer
            pub const TIM1 = @intToPtr(*volatile types.peripherals.TIM1, 0x40012c00);
            ///  Serial peripheral interface
            pub const SPI1 = @intToPtr(*volatile types.peripherals.SPI1, 0x40013000);
            ///  Advanced timer
            pub const TIM8 = @intToPtr(*volatile types.peripherals.TIM1, 0x40013400);
            ///  Universal synchronous asynchronous receiver transmitter
            pub const USART1 = @intToPtr(*volatile types.peripherals.USART1, 0x40013800);
            ///  Analog to digital converter
            pub const ADC3 = @intToPtr(*volatile types.peripherals.ADC2, 0x40013c00);
            ///  General purpose timer
            pub const TIM9 = @intToPtr(*volatile types.peripherals.TIM9, 0x40014c00);
            ///  General purpose timer
            pub const TIM10 = @intToPtr(*volatile types.peripherals.TIM10, 0x40015000);
            ///  General purpose timer
            pub const TIM11 = @intToPtr(*volatile types.peripherals.TIM10, 0x40015400);
            ///  Secure digital input/output interface
            pub const SDIO = @intToPtr(*volatile types.peripherals.SDIO, 0x40018000);
            ///  DMA controller
            pub const DMA1 = @intToPtr(*volatile types.peripherals.DMA1, 0x40020000);
            ///  DMA controller
            pub const DMA2 = @intToPtr(*volatile types.peripherals.DMA1, 0x40020400);
            ...
            pub const ETHERNET_MAC = @intToPtr(*volatile types.peripherals.ETHERNET_MAC, 0x40028000);
            ///  Ethernet: MAC management counters
            pub const ETHERNET_MMC = @intToPtr(*volatile types.peripherals.ETHERNET_MMC, 0x40028100);
            ///  Ethernet: Precision time protocol
            pub const ETHERNET_PTP = @intToPtr(*volatile types.peripherals.ETHERNET_PTP, 0x40028700);
            ///  Ethernet: DMA controller operation
            pub const ETHERNET_DMA = @intToPtr(*volatile types.peripherals.ETHERNET_DMA, 0x40029000);
            ///  USB on the go full speed
            pub const OTG_FS_GLOBAL = @intToPtr(*volatile types.peripherals.OTG_FS_GLOBAL, 0x50000000);
            ///  USB on the go full speed
            pub const OTG_FS_HOST = @intToPtr(*volatile types.peripherals.OTG_FS_HOST, 0x50000400);
            ///  USB on the go full speed
            pub const OTG_FS_DEVICE = @intToPtr(*volatile types.peripherals.OTG_FS_DEVICE, 0x50000800);
            ///  USB on the go full speed
            pub const OTG_FS_PWRCLK = @intToPtr(*volatile types.peripherals.OTG_FS_PWRCLK, 0x50000e00);
            ///  Flexible static memory controller
            pub const FSMC = @intToPtr(*volatile types.peripherals.FSMC, 0xa0000000);
            ///  System control block ACTLR
            pub const SCB_ACTRL = @intToPtr(*volatile types.peripherals.SCB_ACTRL, 0xe000e008);
            ///  SysTick timer
            ...
            ///  Nested vectored interrupt controller
            pub const NVIC_STIR = @intToPtr(*volatile types.peripherals.NVIC_STIR, 0xe000ef00);
            ///  Debug support
